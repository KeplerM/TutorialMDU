...
def edit():
    ...
    editor.iconbitmap("AMADEico.ico")
    ...
    #delete_box_editor.grid(row=9, column=1)
   ...
   #Loop thru results
    ...
    #delete_box_label_editor=Label(editor, text="ID Number")
    #delete_box_label_editor.grid(row=9, column=0)

    #Create an Save button to save record
